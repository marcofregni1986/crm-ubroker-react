            ...
            <div style={{ maxWidth: 800, margin: "0 auto" }}>
                ...
                <div style={{
                    ...
                    <section style={{ marginBottom: 40 }}>
                        ...
                        <div style={{ background: "rgba(59, 130, 246, 0.1)", borderLeft: "4px solid #3b82f6", padding: 16, marginTop: 24, borderRadius: 4 }}>
                            ...
                            <span style={{ fontSize: 13, opacity: 0.8 }}>
                                L'applicazione accede ai dati del calendario solo quando l'utente effettua esplicitamente il login con Google e concede i permessi. I dati sono utilizzati esclusivamente per la sincronizzazione bidirezionale e non vengono conservati su server esterni oltre il necessario per il funzionamento tecnico. L'uso delle informazioni ricevute dalle API di Google aderisce alla <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" style={{ color: "#60a5fa" }}>Google API Services User Data Policy</a>, inclusi i requisiti di utilizzo limitato.
                            </span>
                        </div>
                    </section>
                    ...
                    <section style={{ marginBottom: 40 }}>
                        ...
                        <p style={{ lineHeight: 1.6, opacity: 0.9, marginBottom: 16 }}>
                            La nostra applicazione utilizza Google OAuth per consentire all’utente di collegare il proprio account Google e sincronizzare gli appuntamenti con Google Calendar.
                        </p>
                        ...
                        <div style={{ marginBottom: 16 }}>
                            ...
                            <ul style={{ listStyle: "none", paddingLeft: 0, opacity: 0.9 }}>
                                <li style={{ marginBottom: 6, display: "flex", gap: 10 }}>
                                    ...
                                    <span>Informazioni di base dell’account (es. nome, email, immagine profilo).</span>
                                </li>
                                <li style={{ marginBottom: 6, display: "flex", gap: 10 }}>
                                    <span style={{ color: "#ef4444" }}>•</span>
                                    <span>Dati del calendario (eventi), necessari per creare, modificare o eliminare eventi in base alle azioni dell’utente all’interno dell’app.</span>
                                </li>
                            </ul>
                        </div>

                        <div style={{ marginBottom: 16 }}>
                            <strong style={{ color: "#fff", display: "block", marginBottom: 8 }}>Condivisione e trasferimento:</strong>
                            <p style={{ lineHeight: 1.6, opacity: 0.9, margin: 0 }}>
                                Non condividiamo, non trasferiamo e non divulghiamo i dati Google degli utenti a terze parti. I dati vengono utilizzati esclusivamente per fornire le funzionalità dell’app richieste dall’utente.
                            </p>
                        </div>

                        <div>
                            <strong style={{ color: "#fff", display: "block", marginBottom: 8 }}>Revoca:</strong>
                            <p style={{ lineHeight: 1.6, opacity: 0.9, margin: 0 }}>
