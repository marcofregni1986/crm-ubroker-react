...
function applyTheme(themeKey) {
  // 1. Setta l'attributo data-theme (per themes.css)
  document.documentElement.setAttribute("data-theme", themeKey);

  // 2. Setta anche la classe (per dashboard.css e legacy)
  document.body.classList.remove("theme-dark", "theme-light", "theme-bento", "theme-jarvis");
